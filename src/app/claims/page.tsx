    ...
    return (
        <div className={`flex w-full ${jost.className}`}>
            <div className="w-[1300px] m-auto xs:mt-[70px] mt-claimheadermargin sm:px-[25px] px-[10px]">
                <input type="text" className="xs:w-[360px] w-full xs:text-[24px] text-claimsearchfluid bg-transparent border-b-[1px] placeholder-[#4F4F4F] border-[#4F4F4F] py-1 transition duration-300 ease outline-none focus:border-[#27B17D] hover:border-slate-300 shadow-sm focus:shadow" placeholder="Search" />
